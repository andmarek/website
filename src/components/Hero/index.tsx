  ...
  return (
    <section className="relative w-full">
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div className="h-72 w-72 md:h-[28rem] md:w-[28rem] rounded-full bg-gradient-to-br from-plum/10 via-chinese-violet/5 to-burnt-orange/5 blur-3xl dark:from-plum/20 dark:via-chinese-violet/10 dark:to-burnt-orange/10" />
      </div>
      <div className="text-gray-900 dark:text-champagne-pink flex flex-col items-center font-sans">
        <div className={`transition-opacity duration-1000 ease-in-out max-w-6xl mx-auto w-full flex flex-col-reverse md:flex-row items-center px-4 md:px-8 lg:px-12 py-10 md:py-16 ${loaded ? 'opacity-100' : 'opacity-0'}`}>
          <div id="intro" className="flex-1 text-center md:text-left">
            <p className="text-sm tracking-widest uppercase text-gray-600 dark:text-cinereous">Hello, I&apos;m</p>
            ...
            <div className="mt-3 text-xl md:text-2xl text-gray-700 dark:text-cinereous">
              <DynamicText />
            </div>
          </div>
